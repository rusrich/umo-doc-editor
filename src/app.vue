...
import type { DocumentOptions, PageOption } from '@/types'

import { shortId } from '@/utils/short-id'
import { createDealEditorOptions } from '@/deal-options'
...
const options = $ref(
  createDealEditorOptions({
    ...
    async onSave(
      content: { html: HTMLContent; json: JSONContent; text: string },
      page: PageOption,
